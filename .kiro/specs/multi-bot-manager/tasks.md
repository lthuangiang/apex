...
- [ ] 1.1 Tạo `BotSharedState` interface và factory function
...
- [ ] 1.2 Tạo `BotConfig` và `BotStatus` types
...
- [ ] 1.3 Implement `BotInstance` class
...
- [ ] 1.4 Implement `BotManager` class
...
- [ ] 1.5 Tạo adapter factory function
...
- [ ] 1.6 Tạo default bot-configs.json với 3 bots
...
- [ ] 2.4 Implement Per-bot data routes trong `DashboardServer`
  - File: `src/dashboard/server.ts`
...
- [ ] 2.5 Implement config persistence routes trong `DashboardServer`
  - File: `src/dashboard/server.ts`
...
- [ ] 3.1 Implement Manager Dashboard HTML template
...
- [ ] 3.2 Implement bot card component trong Manager Dashboard
...
- [ ] 3.3 Implement `GET /bots/:id` route — Bot Detail page
  - File: `src/dashboard/server.ts`
...
- [ ] 3.4 Cập nhật `GET /` để trả về Manager Dashboard
  - File: `src/dashboard/server.ts`
  - Nếu chỉ có 1 bot, vẫn hiển thị Manager Dashboard (không auto-redirect)
  - _Requirements: 2.1_

- [ ] 3.5 Tạo EJS partials cho Manager Dashboard
...
- [ ] 4.1 Tạo `loadBotConfigs()` function
...
- [ ] 4.2 Refactor `src/bot.ts` để dùng `BotManager`
  - File: `src/bot.ts`
